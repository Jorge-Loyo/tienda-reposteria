...
export default function ProductForm({ 
  ...
  // Nuevo estado para la vista previa local de la imagen
  ...
  useEffect(() => {
    if (initialData) {
      ...
      // Al editar, la vista previa inicial es la imagen existente
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Si se seleccionó una nueva imagen, la subimos a Cloudinary al momento de guardar
    if (imageFile) {
        setIsUploading(true);
    ...
    try {
      ...
      const productDataToSend = { ...productData, imageUrl: finalImageUrl };
        ...
        <div className="w-full max-w-xs">
          <ProductCard
            product={{
              ...
              imageUrl: imagePreview, // La vista previa ahora usa el estado local
            }}
            bcvRate={null}
          />
        </div>
