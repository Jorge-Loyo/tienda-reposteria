  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-orange-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <p className="text-gray-600 text-center mb-8">Gestiona el contenido visual y promocional de tu tienda</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="glass p-8 rounded-2xl shadow-xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Gestiona imágenes inspiradoras</p>
              </div>
            </div>
            <p className="text-gray-700 mb-6">
              Administra las imágenes que aparecen en la galería de inspiración de la página principal. 
              Muestra creaciones increíbles hechas con tus productos.
            </p>
            <Button asChild className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white">
              <Link href="/admin/marketing/galeria">
                Gestionar Galería
              </Link>
            </Button>
          </div>
          ...
          <div className="glass p-8 rounded-2xl shadow-xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold gradient-text">Configuración del Sitio</h3>
                <p className="text-gray-600">Personaliza imágenes principales</p>
              </div>
            </div>
            <p className="text-gray-700 mb-6">
              Cambia las imágenes principales del sitio como la sección "Quiénes Somos" y otros elementos visuales importantes.
            </p>
            <Button asChild className="w-full bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white">
              <Link href="/admin/marketing/configuracion">
                Configurar Sitio
              </Link>
            </Button>
          </div>
